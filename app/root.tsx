...
export async function loader({ request }: Route.LoaderArgs) {
  ...
  // 사용자 설정은 private layout에서 처리하므로 여기서는 null로 설정
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ThemeProvider
      specifiedTheme={data?.theme ?? null} // Default to system theme if none is specified
...
function InnerLayout({ children }: { children: React.ReactNode }) {
  ...
  // 사용자 설정은 private layout에서 처리하므로 여기서는 제거
