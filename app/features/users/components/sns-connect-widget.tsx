...
interface SnsConnectWidgetProps {
  isConnected?: boolean;
  showSuccessMessage?: boolean;
}

export function SnsConnectWidget({
  isConnected = false,
  showSuccessMessage = false,
}: SnsConnectWidgetProps) {
  const handleConnect = () => {
    // Threads OAuth 인증 페이지로 이동 (온보딩에서 온 경우 파라미터 추가)
    window.location.href = "/api/settings/threads-auth?from=onboarding";
  };
